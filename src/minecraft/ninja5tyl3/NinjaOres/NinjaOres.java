...
import ninja5tyl3.NinjaOres.EventManager;
import ninja5tyl3.NinjaOres.NinjaOres;

public class NinjaOres
{
	//Blocks
		...
		//"Block" Stacks
		ItemStack aluminiumOre = new ItemStack(BlockAluminiumOre);
		ItemStack cobaltOre = new ItemStack(BlockCobaltOre);
		ItemStack copperOre = new ItemStack(BlockCopperOre);
		ItemStack ferrousOre = new ItemStack(BlockFerrousOre);
		ItemStack iridiumOre = new ItemStack(BlockIridiumOre);
		ItemStack leadOre = new ItemStack(BlockLeadOre);
		ItemStack pigIronOre = new ItemStack(BlockPigIronOre);
		ItemStack platinumOre = new ItemStack(BlockPlatinumOre);
		ItemStack silverOre = new ItemStack(BlockSilverOre);
		ItemStack tinOre = new ItemStack(BlockTinOre);
		ItemStack titaniumOre= new ItemStack(BlockTitaniumOre);
		ItemStack tungstenOre = new ItemStack(BlockTungstenOre);
		ItemStack uraniumOre = new ItemStack(BlockUraniumOre);
		ItemStack zincOre = new ItemStack(BlockZincOre);
